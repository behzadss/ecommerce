...
if ($_GET['product-id']) {
    $id = $_GET['product-id'];
    $product_info = mysqli_fetch_array(get_product_id($id));
}


$pcomments = get_comments_by_product_id($id);
?>
<!doctype html>
<html lang="en">
<head>
...
<div id="main">
    <div class="product-page">
        ...
        <div class="box comments">
            <div class="comments-list">
                ...
                <?php while ($pcomment = mysqli_fetch_array($pcomments)) { ?>
                    <div id="comment-item-1" class="comment">
                        ...
                        <div class="comment-date"><?php echo $pcomment['date'] ?></div>
                        <div class="comment-text"><p><?php echo $pcomment['content'] ?></p></div>
            ...
            ?>
            <form action="product.php?product-id=<?php echo $id ?>" method="post">
